...
- Iterating over an array: <details><summary>for...of loops</summary> https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/for...of <br> ``` let iterable = [10, 20, 30]; <br>for (let value of iterable) {
  value += 1;
  console.log(value);
}
// 11
